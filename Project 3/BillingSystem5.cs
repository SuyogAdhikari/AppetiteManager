...
namespace Appitite_Manager_9
{
    public partial class BillingSystem5 : Form
    {
        ...
        public BillingSystem5()
        {
            ...
            string query = "Select * from appititemanager1.table5"; // set query to fetch data "Select * from  tabelname"; 
