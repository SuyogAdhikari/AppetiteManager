...
namespace Appitite_Manager_9
{
    public partial class BillingSystem2 : Form
    {
        ...
        public BillingSystem2()
        {
            ...
            string query = "Select * from appititemanager1.table2"; // set query to fetch data "Select * from  tabelname"; 
