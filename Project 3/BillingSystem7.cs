...
namespace Appitite_Manager_9
{
    public partial class BillingSystem7 : Form
    {
        ...
        public BillingSystem7()
        {
            ...
            string query = "Select * from appititemanager1.table7"; // set query to fetch data "Select * from  tabelname"; 
        ...
        private void BillingSystem7_Load(object sender, EventArgs e)
        {
