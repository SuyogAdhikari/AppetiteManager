...
namespace Appitite_Manager_9
{
    ...
    public partial class SoupEdit : UserControl
    {
        ...
        public SoupEdit()
        {
            ...
            string SelectQuery = "SELECT *FROM appititemanager1.fooditem where foodtype='Soup'";
        ...
        private void populateitem()
        {
            ...
            {
                SoupDisplay.Controls.Add(panel);
            }
        }

        private void SoupEdit_Load(object sender, EventArgs e)
        {
