...
namespace Appitite_Manager_9
{
    public partial class BillingSystem6 : Form
    {
        ...
        public BillingSystem6()
        {
            ...
            string query = "Select * from appititemanager1.table6"; // set query to fetch data "Select * from  tabelname"; 
