...
namespace Appitite_Manager_9
{
    public partial class BillingSystem4 : Form
    {
        ...
        public BillingSystem4()
        {
            ...
            string query = "Select * from appititemanager1.table4"; // set query to fetch data "Select * from  tabelname"; 
